...
class Statistic_widget
{
	...
	function create()
	{
		...
		$data['user_registration'] = ($this->CI->preference->item('allow_user_registration')) ? '<font style="background: green; color: white; padding: 0 3px;">'.$this->CI->lang->line('dashboard_statistics_online').'</font>' : '<font style="background: red; color: white; padding: 0 3px;">'.$this->CI->lang->line('dashboard_statistics_offline').'</font>';
