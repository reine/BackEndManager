...
function index()
{
	...
	$this->load->library('dashboard/Apps_widget');
	$this->load->library('dashboard/Statistic_widget');

	// Assign widgets to dashboard
	$this->dashboard->assign_widget(new widget($this->lang->line('dashboard_example'),$this->lang->line('dashboard_example_body')),'top');
	$this->dashboard->assign_widget(new widget($this->lang->line('dashboard_apps'),$this->apps_widget->create()),'left');
